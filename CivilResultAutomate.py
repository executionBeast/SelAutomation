...
wb = load_workbook('Civil2ndYearResult.xlsx')
ws = wb.active
...
##adButton = driver.find_element(By.ID,"details-button")
##sleep(1)
##adButton.click()
##proceedWithoutSafe = driver.find_element(By.ID,"proceed-link")
##proceedWithoutSafe.click()
...
#invalid roll no. 2007350000013
rollno = "2007350000069"
...
tbody = driver.find_element(By.XPATH,"/html/body/form/div[3]/table/tbody/tr/td/div/table[2]/tbody/tr[2]/td/div[1]/div[2]/div/div/div/div[1]/table/thead/tr[6]/td/table/tbody/tr/td/div/table/tbody")
...
PracticalPhys = tbody.find_element(By.XPATH,"tr[7]")   #in result practical physics is on 5 row for IT branch it is in 6th row
...
def addMarksToExcel():
    ...
    wb.save('Civil2ndYearResult.xlsx')
    wb.close()
